                            ...
                            <div class="row row-no-padding row-col-separator-xl">
                                <div class="col-md-12 col-lg-5 col-xl-5">
                                    ...
                                    <div class="kt-widget1">
                                        <div class="kt-widget1__item">
                                            ...
                                            <span class="kt-widget1__number kt-font-brand  kt--align-left"><%=teacher.getId()%></span>
                                        </div>
                                        ...
                                        <div class="kt-widget1__item">
                                            ...
                                            <span class="kt-widget1__number kt--font-info kt--align-left"><%=teacher.getFirstName() + " " + teacher.getLastName()%></span>
                                        </div>
                                        ...
                                        <div class="kt-widget1__item">
                                            ...
                                            <span class="kt-widget1__number kt--font-info kt--align-left"><%=teacher.getEmail()%></span>
                                        </div>
                                        ...
                                        <div class="kt-widget1__item">
                                            ...
                                            <span class="kt-widget1__number kt--font-info kt--align-left"><%=teacher.getDateOfBirth()%></span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 col-lg-5 col-xl-5">
                                    <div class="kt-widget1">
                                        <div class="kt-widget1__item">
                                            ...
                                            <span class="kt-widget1__number kt--font-success"><%=teacher.getGender().name()%></span>
                                        </div>
                                        <div class="kt-widget1__item">
                                            <div class="kt-widget1__info">
                                                <h3 class="kt-widget1__title">Phone Number</h3>
                                            </div>
                                            <span class="kt-widget1__number kt--font-success"><%=teacher.getPhoneNumber()%></span>
                                        </div>
                                ...
                                <div class="col-md-12 col-lg-2 col-xl-2">
                                    <div class="kt-widget__media text-center m-3">
                                        <img src="<%=teacher.getImg_url()%>" height="120" alt="image img img-thumbnail rounded mx-auto d-block">
                                    </div>
                                </div>
                            </div>
                        </div>
