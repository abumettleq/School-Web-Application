...
<head>
    ...
    <script>
        ...
        function toggleTableVisibility() {
            ...
            if (classNumber !== "" || classNumber !== "Select a class") {
                attendanceTable.style.display = 'block';
                updateStudentList(classNumber);
            } else {
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <form action="submit-attendance" method="post">
                                                                                ...
                                                                                <select name="classNumber" id="classNumber" onchange="toggleTableVisibility()">
