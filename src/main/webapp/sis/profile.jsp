                            ...
                            <div class="row row-no-padding row-col-separator-xl">
                                    ...
                                    <div class="kt-widget1">
                                        <div class="kt-widget1__item">
                                            <div class="kt-widget1__info">
                                                <h3 class="kt-widget1__title">Student ID</h3>
                                            </div>
                                            <span class="kt-widget1__number kt-font-brand  kt--align-left"><%=student.getId()%></span>
                                        </div>

                                        <div class="kt-widget1__item">
                                            <div class="kt-widget1__info">
                                                <h3 class="kt-widget1__title">Student Name</h3>
                                            </div>
                                            <span class="kt-widget1__number kt--font-info kt--align-left"><%=student.getFirstName() + " " + student.getLastName()%></span>
                                        </div>
                                        ...
                                        <div class="kt-widget1__item">
                                            ...
                                            <span class="kt-widget1__number kt--font-info kt--align-left"><%=student.getEmail()%></span>
                                        </div>
                                        ...
                                        <div class="kt-widget1__item">
                                            ...
                                            <span class="kt-widget1__number kt--font-info kt--align-left"><%=student.getDateOfBirth()%></span>
                                        </div>
                                        <div class="kt-widget1__item">
                                            <div class="kt-widget1__info">
                                                <h3 class="kt-widget1__title">Guardian Name</h3>
                                            </div>
                                            <span class="kt-widget1__number kt--font-info kt--align-left"><%=student.getParentGuardianName()%></span>
                                        </div>
                                ...
                                <div class="col-md-12 col-lg-5 col-xl-5">
                                    <div class="kt-widget1">
                                        <div class="kt-widget1__item">
                                            <div class="kt-widget1__info">
                                                <h3 class="kt-widget1__title">Current Class-Section</h3>
                                            </div>
                                            <span class="kt-widget1__number kt--font-success"><%=student.getClass_name() + "-" + student.getSection()%></span>
                                        </div>
                                        <div class="kt-widget1__item">
                                            <div class="kt-widget1__info">
                                                <h3 class="kt-widget1__title">Gender</h3>
                                            </div>
                                            <span class="kt-widget1__number kt--font-success"><%=student.getGender().name()%></span>
                                        </div>
                                        <div class="kt-widget1__item">
                                            <div class="kt-widget1__info">
                                                <h3 class="kt-widget1__title">Phone Number</h3>
                                            </div>
                                            <span class="kt-widget1__number kt--font-success"><%=student.getPhoneNumber()%></span>
                                        </div>
                                        <div class="kt-widget1__item">
                                            <div class="kt-widget1__info">
                                                <h3 class="kt-widget1__title">Admission Date</h3>
                                            </div>
                                            <span class="kt-widget1__number kt--font-success"><%=student.getAdmissionDate()%></span>
                                        </div>
                                        <div class="kt-widget1__item">
                                            <div class="kt-widget1__info">
                                                <h3 class="kt-widget1__title">Graduation Date</h3>
                                            </div>
                                            <span class="kt-widget1__number kt--font-success"><%=student.getGraduationDate()%></span>
                                        </div>

                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-2 col-xl-2">
                                    <div class="kt-widget__media text-center m-3">
                                        <img src="<%=student.getImg_url()%>" height="120" alt="image img img-thumbnail rounded mx-auto d-block">
                                    </div>
                                </div>
                            </div>
                        </div>
