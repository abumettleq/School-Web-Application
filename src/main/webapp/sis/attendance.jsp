...
<%@ page import="com.example.demo.Entity.Attendance" %>
                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__body kt-portlet__body--fit">
                            <div class="row row-no-padding row-col-separator-xl">
                                <%
                                    Map<String, Map<String, List<Attendance>>>  attendanceMap = (Map<String, Map<String, List<Attendance>>>) request.getAttribute("attendanceMap");
                                %>
                                ...
                                <div class="container">
                                    <h2>Attendance</h2>
                                    <br>
                                    <%for (String classNumber : attendanceMap.keySet()) {%>
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" href="#collapse<%=classNumber%>">
                                                    Class <%=classNumber%>
                                                </a>
                                            </h4>
                                        </div>
                                        <div id="collapse<%=classNumber%>" class="panel-collapse collapse">
                                            <ul class="list-group">
                                                <%     Map<String, List<Attendance>> subjectAttendanceMap = attendanceMap.get(classNumber);
                                                    for(String subjectName : subjectAttendanceMap.keySet()) {
                                                %>
                                                    <ul class="list-group">
                                                    <li class="list-group-item">
                                                    <a data-toggle="collapse" href="#collapse<%=subjectName%>">
                                                        <%=subjectName%>
                                                    </a>
                                                    <div id="collapse<%=subjectName%>" class="panel-collapse collapse">
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                            <%
                                                                List<Attendance> attendanceList = subjectAttendanceMap.get(subjectName);
