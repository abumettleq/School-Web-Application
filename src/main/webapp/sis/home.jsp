...
<%@ page import="com.example.demo.Service.TeacherService" %>
<%@ page import="jakarta.persistence.EntityManager" %>
<%@ page import="jakarta.persistence.Persistence" %>
<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
<%
    List<Notification> notificationList = (List<Notification>) request.getAttribute("studentNotifications");
%>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>S.I.S Home</title>
                                    ...
                                    %>
                                            <div class="notification">
                                                ...
                                                <div class="notification-content">
                                                    <p><strong><%=notificationList.get(i).getSentBy()%></strong> <%=notificationList.get(i).getContent()%></p>
                                                    <span class="notification-time">At <%=notificationList.get(i).getSentTime()%>, <%=notificationList.get(i).getSentDate()%></span>
                                                </div>
                                            </div>
                                    <%
                                        }
